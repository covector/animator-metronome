<script>
    ...
    const interval = $page.url.searchParams.get('interval') != null ? 
...
<svelte:head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,700&display=swap" rel="stylesheet">
</svelte:head>
